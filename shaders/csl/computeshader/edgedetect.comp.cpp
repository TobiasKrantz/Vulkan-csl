...
[[csl::compute(16, 16, 1)]] void compute_main()
{
      ...
      Kernel kernel;
      kernel.weight[0] = -1.0f / 8.0f;
      kernel.weight[1] = -1.0f / 8.0f;
      kernel.weight[2] = -1.0f / 8.0f;
      kernel.weight[3] = -1.0f / 8.0f;
      kernel.weight[4] = 1.0f;
      kernel.weight[5] = -1.0f / 8.0f;
      kernel.weight[6] = -1.0f / 8.0f;
      kernel.weight[7] = -1.0f / 8.0f;
      kernel.weight[8] = -1.0f / 8.0f;

      f32 value = convolve(kernel, data, 0.1f, 0.0f);
